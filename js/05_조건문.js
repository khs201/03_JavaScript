...
const inputAge = document.getElementById("inputAge"); // input 값 얻어오기
...
function calc(op) {
    ...
    // 매개 변수(Parameter) op(op말고 다른 이름 아무거나여도 된다)
    ...
    switch (op) {
        ...
        case '+': result = v1 + v2; // 멈추지 않고 -로 넘어가서 +를 눌러도 -가 작동
