...
test1c.onclick = function () { // onclick에 저장된 값이 덮어 씌워지면서 이전 코드 (배경색 red)가 사라지는 문제가 발생
...
test2.addEventListener("click", function () {
    ...
    // console.log(test2.style.opacity);
});
...
test2.addEventListener("click", function () {
    ...
    /* 표준 이벤트 모델의 이벤트 핸들 안에서 this == 이벤트가 발생한 요소 */
    console.log(this);
